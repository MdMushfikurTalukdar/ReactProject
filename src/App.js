...
import VerifyBonafiedCertificate from "./components/VeryBonafiedCertificate.jsx";
function App() {
  const firstName = "John Doe";
  const enrollment = "123456";
  const marksheetImage = "https://images.unsplash.com/photo-1705179116249-a659af885205?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwyMHx8fGVufDB8fHx8fA%3D%3D"; // URL to the marksheet image
    ...
    <>
        <Router>
          <Routes>
            ...
            <Route path="/VerifyBonafiedCertificate" element={  <VerifyBonafiedCertificate
      firstName={firstName}
