            ...
            <div className="laptopLarge" >
                <div style={{ color: "white", fontSize: "1rem"}}>
                    ...
                    <div id="text0" ref={scrollRef0} style={{ width: '578px', marginTop: "150px", marginBottom: "200px" }}>
                        ...
                        <center><Button variant="outlined" style={{ width: "150px", height: "50px", marginTop: "20px", marginBottom: "20px",fontFamily:"cursive"}} onClick={(e)=>navigate('/register')}>Join with Us</Button></center>
                    </div>
